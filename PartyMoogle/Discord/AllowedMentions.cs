...
public class AllowedMentionsBuilder
{
    ...
    {
        if (roles.Length > 100) throw new ArgumentException("You can only mention up to 100 roles.");
    ...
    {
        if (users.Length > 100) throw new ArgumentException("You can only mention up to 100 users.");
